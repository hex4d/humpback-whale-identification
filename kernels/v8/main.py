...
if __name__ == '__main__':
    ...
    if args.pred:
        # load models
        model = models.load_model('./models/without_whalev8/98epochs_3.2204.hdf5')
        # load test data
        ...
        model_wrapper.train(train_generator, val_generator, [model_checkpoint, tensor_board], epochs=10, initial_epoch=0)

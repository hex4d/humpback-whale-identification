...
class ModelV9():
    ...
    def init_model(self):
        ...
        trimmed_model = models.Model(inputs=model.input, outputs=model.layers[-3].output)
        trimmed_model.get_layer(name='dropout_1').name = 'pre_dropout1'
        trimmed_model.get_layer(name='dense_1').name = 'pre_dense1'
        trimmed_model.get_layer(name='batch_normalization_1').name = 'pre_batch_normalization_1'
